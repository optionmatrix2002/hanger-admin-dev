...
this.status=e;
  ...
  constructor(public appSettings:AppSettings, private adminsettings :AdminsettingsService) 
  {
    ...
    this.users = [
      { Id: 1, severity:'Medium', title: 'Gmail Unauthorized signin', message:"Gmail message centre notifying malicious access of your account", location:'India' },
      { Id: 1, severity:'High', title: 'Facebook Unauthorized signin', message:"Facebook message centre notifying malicious access of your account", location:'US' },
    ]
