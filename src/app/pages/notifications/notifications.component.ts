...
this.status=e;
  ...
  constructor(public appSettings:AppSettings, private adminsettings :AdminsettingsService) 
  {
    ...
    this.users = [
      { Id: 1, type: 'Email Notifications', status:true},
      { Id: 2, type: 'Text Notifications', status:true},
      { Id: 3, type: 'Push Notifications', status:true},
      { Id: 4, type: 'On Screen Notifications', status:true},
    ]
