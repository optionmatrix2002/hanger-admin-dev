...
this.status=e;
  ...
  constructor(public appSettings:AppSettings) 
  {
    ...
    this.users = [
      { Id: 1, user_name: 'Oliver', name: 'Boutique Event', description:"Sells women's clothing, purses and shoes.", capacity:'1000', tickets:'Free', visibility:'Public',location:'India',status:true },
      { Id: 3, user_name: 'Harry', name: 'Boutique Event', description:"Sells women's clothing, purses and shoes.", capacity:'1000', tickets:'Paid', visibility:'Private',location:'US',status:true },
      { Id: 2, user_name: 'Cooper',  name: 'Boutique Event', description:"Sells women's clothing, purses and shoes.", capacity:'1000', tickets:'Free', visibility:'Public',location:'UK',status:true },
    ];
