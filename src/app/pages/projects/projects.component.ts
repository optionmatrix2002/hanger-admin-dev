...
this.status=e;
  ...
  constructor(public appSettings:AppSettings, private adminsettings :AdminsettingsService) 
  {
    ...
    this.users = [
      { Id: 1, name: 'Fashion Curation Panel', badge_type:"Bronze", description:"To  celebrates Hazel Clark and Annamari Vänskä's highly recommended book Fashion Curating (Bloomsbury, 2018) and the new issue of Fashion Projects",owner:'Cooper',status:true},
    ];
