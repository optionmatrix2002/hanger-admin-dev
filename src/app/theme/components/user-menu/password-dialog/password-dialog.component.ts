...
export class PasswordDialogComponent implements OnInit {
  ...
  constructor(private loginService : LoginService,public dialogRef: MatDialogRef<PasswordDialogComponent>,@Inject(MAT_DIALOG_DATA) public user: number, private fb: FormBuilder, private alertService: AlertService) { 
